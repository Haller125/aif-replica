...
This repository contains a Next.js application that serves as a replica of [AIF webpage](https://astanainternationalforum.org/en). The project aims to demonstrate the capabilities of Next.js in creating high-performance, static React applications.
